...
add_action('wp_footer', 'add_lhc_widget');
function add_lhc_widget() {
    ?>  
		<script>
			var LHC_API = LHC_API||{};
			LHC_API.args = {mode:'widget',lhc_base_url:'//34.136.1.66:8080/index.php/',wheight:450,wwidth:350,pheight:520,pwidth:500,fresh:true,leaveamessage:true,check_messages:false,proactive:false};
			(function() {
			var po = document.createElement('script'); po.type = 'text/javascript'; po.setAttribute('crossorigin','anonymous'); po.async = true;
			var date = new Date();po.src = '//34.136.1.66:8080//design/defaulttheme/js/widgetv2/index.js?'+(""+date.getFullYear() + date.getMonth() + date.getDate());
